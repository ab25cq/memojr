...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull FloatingActionButton fab, @NonNull FloatingActionButton fabImage,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.fabImage;
      FloatingActionButton fabImage = ViewBindings.findChildViewById(rootView, id);
      if (fabImage == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((CoordinatorLayout) rootView, breadcrumbContainer,
          breadcrumbScroll, fab, fabImage, recyclerView, toolbar, tvEmpty);
    }
