...
public final class ItemFolderBinding implements ViewBinding {
  ...
  private ItemFolderBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvFolderName) {
  ...
  public static ItemFolderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFolderBinding((MaterialCardView) rootView, tvFolderName);
    }
